...
import numpy as np
import pandas as pd
from get_worst_p_quadratic_mc_mc import get_worst_p_quadratic_mc_mc
...
def compute_average_worst_prob(delta, loss_threshold, mu, Sigma, N_alpha,N_tot, runs, rng,Q,r,s):
    ...
    u_bar,_,_,var_H_,var_p_= get_worst_p_quadratic_mc_mc(delta,loss_threshold,mu,Sigma,1/2,N_alpha,rng,Q,r,s)
    ...
    for i in range(runs):
        ...
        u_bar_,p_hat, _, var_H,var_p= get_worst_p_quadratic_mc_mc(delta,
                                            loss_threshold,
                                            mu,
                                            Sigma,
...
if __name__ == "__main__":
    ...
    run_threshold_sweep(
        ...
        runs=runs,
        rng=rng,Q=Q,r=r,s=s,
        out_csv="MC_quadratic_results.csv"
    )
    '''
