...
def get_worst_p_piecewise_mc_cis(delta, loss_threshold, mu, Sigma, w, alpha,N,rng,A,B,a,b,u_opt=None):
    ...
    ### SOLVE h(u) = delta^2
    u_bar,var_H = get_radius_mc_piecewise(delta**2,loss_threshold,w,A_tilde,B_tilde,a_tilde,b_tilde,N1,rng)
    ...
    p_hat, err, var_p = robust_cis_piecewise(u_bar,d2,L1)
