...
def get_worst_p_piecewise_cis_mc(delta, loss_threshold, mu, Sigma, w, alpha,N,rng,A,B,a,b,u_opt=None):
    ...
    p_hat,err,var_p= robust_mc_piecewise(u_bar,loss_threshold,w,N2,A_tilde,B_tilde,a_tilde,b_tilde,rng)
