...
import numpy as np
import pandas as pd
from get_worst_p_piecewise_cis_mc import get_worst_p_piecewise_cis_mc
...
def compute_average_worst_prob(delta, loss_threshold, mu, Sigma, w, N_alpha,N_tot, runs, rng,A,B,a,b):
    ...
    u_bar,_,_,var_H_,var_p_= get_worst_p_piecewise_cis_mc(delta,loss_threshold,mu,Sigma,w,1/2,N_alpha,rng,A,B,a,b)
    ...
    for i in range(runs):
        ...
        u_bar_,p_hat, _, var_H,var_p= get_worst_p_piecewise_cis_mc(delta,
                                            loss_threshold,
                                            mu,
                                            Sigma,
                                            w,
...
if __name__ == "__main__":
    ...
    run_threshold_sweep(
        ...
        out_csv="CIS_MC_piecewise_results.csv"
    )
